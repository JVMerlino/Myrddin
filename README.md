Myrddin v0.90 Release Notes -- 6/9/23
--------------------------------------------------------------------------------
...
Version 0.89 plays approximately 2650 ELO (CCRL) at 1 CPU and 2730 at 4 CPU against chess engines, and probably 100-200 points higher against humans. This is an improvement of approximately 50 points compared to version 0.89.
...
- Logfiles will be in the “logs” folder below the folder where you ran Myrddin. The output of the log is not very interesting. It's just PV output and communication reality-check stuff. If you are running Myrddin with multiple CPUs, there will be one logfile for each process.
...
Version 0.81 (5/26/09) Change List:
...
Please send bug reports and general suggestions/comments to 
JohnVMerlino@gmail.com.
